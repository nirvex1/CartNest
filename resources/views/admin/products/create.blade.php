            ...
            <form method="POST" action="/admin/products">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="price" step="0.01" min="0" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('price') }}" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" name="stock_quantity" min="0" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('stock_quantity', 0) }}" required>
                    </div>

                    <div>
                        <label class="block text-gray-700 font-semibold mb-2">Image URL</label>
                        <input type="text" name="image_url" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('image_url') }}" placeholder="https://...">
                    </div>
                </div>
